    ...
    <div class="container text-primary">
      ...
      <div class="row flex-nowrap mt-3" style={{display:'flex'}}>
        <div class="col-lg-4 test">
          <img class="w-full" src={beltei_tour_yak_laom_lake} />
      ...
      <div class="row flex-nowrap mt-3" style={{display:'flex'}}>
        <div class="col-lg-4 test">
          <img class="w-full" src={beltei_tour_cha_ung_water} />
      ...
      <div class="row flex-nowrap mt-3" style={{display:'flex'}}>
        <div class="col-lg-4 test">
          <img class="w-full" src={beltei_tour_minority_village} />
        </div>
        <div class="col-lg-8 text-primary testdiv">
        <p class="text-justify testp ">
      ...
      <div class="row flex-nowrap mt-3" style={{display:'flex'}}>
        <div class="col-lg-4 test">
         <img class="w-full" src={beltei_tour_lumphat_wildlife} />
        </div>
        <div class="col-lg-8 text-primary testdiv">
        <p class="text-justify testp ">
