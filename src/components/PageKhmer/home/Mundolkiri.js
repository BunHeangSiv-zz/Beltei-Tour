...
function UseButton() {
  return (
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-3">
          <div ><img className="d-block w-16 md:w-32 lg:w-48 pt-1 " src={beltei_tour_la_eang_waterfall} /></div>
      ...
      <p class="text-primary text-justify" > province. At its base, there is a big water reservoir
         in which tourists can swim happily.</p>
      <br></br>
      <div class="row">
        <div class="col-lg-3">
          <div ><img className="d-block w-16 md:w-32 lg:w-48 pt-1 " src={beltei_tour_bousra_wasterfall} /></div>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div ><img className="d-block w-16 md:w-32 lg:w-48 pt-1 " src={beltei_tour_dei_ey_home_stay} /></div>
        </div>
        <div class="col-lg-9 text-primary text-justify" >
        The Last attraction on our list is the Dei Ey community home stay, The area is extremely scenic and is a semi evergreen and bamboo plantations. The community homestay here offers guests an opportunity to enjoy a more local and simple travelling experience.        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div ><img className="d-block w-16 md:w-32 lg:w-48 pt-1 " src={beltei_tour_pahlung_village} /></div>
        </div>
        <div class="col-lg-9 text-primary text-justify" >
      ...
      <div class="row">
        <div class="col-lg-3">
          <div ><img className="d-block w-16 md:w-32 lg:w-48 pt-1 " src={beltei_tour_mironty_group} /></div>
        </div>
        <div class="col-lg-9 text-primary text-justify" >
      ...
      <p class="text-primary  text-justify" > province,
         some people will not know of the khmer language.</p>
