...
function UseButton() {
  return (
    <div class="container text-primary">
      ...
      <div class="row">
        <div class="col-lg3">
          <div ><img className="w-16 md:w-32 lg:w-48 pt-1 " src={beltei_tour_independence_beach} /></div>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div ><img className="d-block w-16 md:w-32 lg:w-48 pt-1 " src={beltei_tour_khbal_chhay_waterfall} /></div>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div ><img className="d-block w-16 md:w-32 lg:w-48 pt-1 " src={beltei_tour_koh_rong} /></div>
        </div>
        <div class="col-lg-9 text-primary" >
        <p class="text-justify">
      ...
      <div class="row">
        <div class="col-lg-3">
          <div ><img className="d-block w-16 md:w-32 lg:w-48 pt-1 " src={beltei_tour_ream_national_park} /></div>
        </div>
