...
function UseButton() {
  return (
    <div class="container text-primary">
      ...
      <div class="row">
        <div class="col-lg-3">
          <div ><img className="d-block w-16 md:w-32 lg:w-48 pt-1 " src={beltei_tour_temple_hopping} /></div>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div ><img className="d-block w-16 md:w-32 lg:w-48 pt-1 " src={beltei_tour_bayon_temple} /></div>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div ><img className="d-block w-16 md:w-32 lg:w-48 pt-1 " src={beltei_tour_visiting_floating} /></div>
        </div>
        <div class="col-lg-9 text-primary text-justify" >
        <p class="text-justify">
      ...
      <div class="row">
        <div class="col-lg-3">
          <div ><img className="d-block w-16 md:w-32 lg:w-48 pt-1 " src={beltei_tour_landmine_museum} /></div>
        </div>
        <div class="col-lg-9 text-primary text-justify" >
        <p class="text-justify">
